...
const Pagamentos = () => {
  ...
  const loadPagamentos = async (isReceitas) => {
    try {
      ...
      const response = await axios.get(`https://coin-backend-production-66e9.up.railway.app/api/pagamentos/${tipo}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (pagamentoAtual) {
        await axios.put(`https://coin-backend-production-66e9.up.railway.app/api/pagamentos/${pagamentoAtual.id}`, pagamento);
      } else {
        await axios.post('https://coin-backend-production-66e9.up.railway.app/api/pagamentos', pagamento);
      }
      loadPagamentos(isReceitas);
      closeModal();
    } catch (error) {
  ...
  const confirmarDelecao = async () => {
    try {
      await axios.delete(`https://coin-backend-production-66e9.up.railway.app/api/pagamentos/${pagamentoParaDeletar.id}`);
      loadPagamentos(isReceitas);
      closeDeleteModal();
    } catch (error) {
